...
class HandTracker():
    def __init__(self,statMode = False, maxHands = 2, minDetect = 0.5, minTrack=0.5):
        ...
        self.hands = self.mpHands.Hands(self.statMode,self.maxHands,self.minDetect,self.minTrack)
    ...
    def findPosition(self,img,handNo=0,draw=True,idNum=8):
